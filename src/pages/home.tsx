  ...
  return c.html(
    <html>
      <head>
        ...
        <meta property="og:url" content="https://hqaudio.suvojeetsengupta.in/" />
        <meta property="og:title" content={title} />
        <meta property="og:description" content={description} />
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:url" content="https://hqaudio.suvojeetsengupta.in/" />
        <meta property="twitter:title" content={title} />
        <meta property="twitter:description" content={description} />
        <meta
          property="og:image"
          content="https://raw.githubusercontent.com/suvojeet-sengupta/jiosaavn-api/main/assets/preview.jpg"
        />
        <meta
        ...
        <link
          rel="icon"
          type="image/x-icon"
          href="https://raw.githubusercontent.com/suvojeet-sengupta/jiosaavn-api/main/assets/favicon.ico"
        />
        ...
        <main class="mx-auto my-auto flex flex-col space-y-8 px-4 pb-8 md:py-10 relative overflow-y-hidden overflow-x-hidden">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-4 lg:grid-cols-4 xl:grid-cols-8 gap-2 sm:gap-0 relative grid-flow-row">
            ...
            <a
              target="_blank"
              class="p-4 sm:p-8 hover:bg-opacity-5 hover:bg-white rounded-lg duration-100 sm:col-span-4"
              href="https://github.com/suvojeet-sengupta/jiosaavn-api"
            >
              <div class="flex flex-col">
            ...
            <a
              target="_blank"
              class="p-4 sm:p-8 hover:bg-opacity-5 hover:bg-white rounded-lg duration-100 sm:col-span-4"
              href="https://github.com/suvojeet-sengupta/jiosaavn-api/issues"
            >
              <div class="flex flex-col">
